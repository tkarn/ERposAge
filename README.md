...
## This resource contains the following data regarding the Affymetrix microarray analyses described in the paper:
...
2. [*Affymetrix_Analyses.html*](https://github.com/tkarn/ERposAge/blob/master/Affymetrix_Analyses.html):  The corresponding code together with all output from Affymetrix_Analyses.Rmd
